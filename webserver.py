...
#handler calss to execute the code based on http requesst to send data to client
    ...
    def do_GET(self):
        try:
            ...
            if self.path.endswith("/"):
                ...
                output += "<a href = '/catalog/new' > Add New Category </a></br></br>"
                ...
                for i in catalog:
                    ...
                    output += "<a href ='/restaurants/%s/edit' >Edit </a> "%catalog.id
                    output += "</br>"
                    output += "<a href ='/restaurants/%s/delete' >Delete </a> "%catalog.id
                    output += "</br></br></br>"
